...
export function RestaurantListPage(props: RestaurantListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getRestaurants({
        ...
        order: params.order,
        searchTermKeys: ['description.contains', 'address.contains', 'hours_of_operation.contains', 'name.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'hours_of_operation', header: 'Hours Of Operation', accessorKey: 'hours_of_operation' },
